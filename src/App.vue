...
function toggleModal(game?: any) {
  ...
  if (modal != null) {
    if (modal.open) {
      ...
      dialogTitle.value = game.title;
      dialogDesc.value = game.desc;
      modal.showModal();
    }
  }
}
