...
<template>
	...
	<div class="set-ratio">
		...
		<div id="guide-box">
		    ...
		    <p>These try to keep things as spoiler-free as possible 
		    so that you can play through the game for the first time with the peace of mind that you are not 
		    missing anything permanently missable.</p>
		</div>
		<div id="timeline-box">
